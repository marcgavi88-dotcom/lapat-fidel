export const ca = {
  ...
  misPremios: {
    ...
    showAtCounter: "Ensenya aquest codi al cambrer a taula",
    waiterFlowTitle: "Com bescanviar els teus codis",
    waiterFlowStep1: "Vine a menjar a L'Àpat del Prat",
    waiterFlowStep2: "Ensenya el codi al cambrer i ell el validarà a taula",
    waiterFlowFooter: "Pots bescanviar punts per premis sempre que vulguis. La validació es fa només al moment del menjar.",
